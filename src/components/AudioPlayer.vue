<template>
  <div>
    ...
    <q-slide-transition>
      ...
      >
        <!-- 音声封面 -->
        <div class="relative-position bg-dark row items-center albumart">
          ...
          >
            <q-menu anchor="bottom right" self="top right">
              <q-item
                clickable
                v-ripple
                @click="hideSeekButton = !hideSeekButton"
              >
              ...
              <q-item
                clickable
                v-ripple
                @click="swapSeekButton = !swapSeekButton"
              >
                <q-item-section avatar>
          ...
          <q-btn
            ...
            align="between"
            :color="desktopLrc ? 'primary' : 'white'"
            size="12px"
            text-color="dark"
            label="桌面字幕"
            icon="subtitles"
        ...
        <q-item
          style="height: 55px; padding: 0px 15px"
        ...
        <div
          class="row items-center q-mx-lg"
          style="height: 50px"
...
import PipLrc from 'components/PipLrc.vue'
